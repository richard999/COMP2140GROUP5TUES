 ...
 * @author IT-Earl
 */
public class SubFormAddPayment extends JPanel{
    private final JTextField txtId, txtName, txtAmount;
    
    public SubFormAddPayment(String id, String name){
    ...
    private void _goAdd(){
        ...
        try {
            ...
            st.executeUpdate("ALTER TABLE tbl_cashadvancepayment"
                    + " auto_increment=1");
            st.executeUpdate("INSERT INTO tbl_cashadvancepayment (Employee_Id, Payment_Amount, Payment_Date)"
