 ...
 * @author IT-Earl
 */
public class SubFormEditPayment extends JPanel{
    private final JTextField txtId, txtName, txtCashId, txtDate, txtAmount;
    
    public SubFormEditPayment(String id, String name, String paymentId, String paymentDate, float amount){
    ...
    protected void _goEdit(){
        ...
        try {
            ...
            st.executeUpdate("UPDATE tbl_cashadvancepayment SET Payment_Amount='"+nFunction._stripValue(txtAmount.getText())+"'"
                    + " WHERE Employee_Id='"+txtId.getText()+"' AND Payment_Id='"+txtCashId.getText()+"'");
